 ...
 * The two apps also have entirely disjoint dictionaries and their own storage
 * keys, so what would actually be shared is sixty lines of boilerplate.
 */
